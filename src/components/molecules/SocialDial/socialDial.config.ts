...
export interface SocialDialBrand {
  ...
  brand: string;
  /** Sobreescribe la cara en hover (para degradados como el de Instagram). */
  brandFace?: string;
  /** Color del canto/grosor en reposo. */
  edge: string;
  /** Color del canto/grosor en hover. */
  edgeHover: string;
...
export const SOCIAL_DIAL_BRANDS: Record<SocialDialId, SocialDialBrand> = {
  ...
  github: {
    ...
    /* La cara y el canto en hover necesitan un piso de luminosidad: el
       portafolio tiene fondo casi negro (#09090b) y con los tonos originales
       (#2B3137 / #171B1F) el contraste era 1.51 y 1.15 — la porción se
       desvanecía en el fondo. El icono en reposo sigue usando `brand`. */
    brandFace: "#30363D",
    edge: "#CFD4DA",
    edgeHover: "#474E57",
  ...
  x: {
    brand: "#101014",
    /* Mismo caso que GitHub, más extremo: #101014 y #000000 daban contraste
       1.05 y 1.06 sobre el fondo del sitio, o sea invisibles. */
    brandFace: "#26282E",
    edge: "#CFD4DA",
    edgeHover: "#3C3F47",
